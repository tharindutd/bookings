    ...
    <div id="main-row" class="row">
        <div id="left-side" class="col-xs-12 col-sm-12 col-md-12 col-xl-3">
            <div id="main-search">
                ...
                <input type="search" class="form-control destiny2" id="destiny" list="districtset">
                ...
                <div class="d-pic">
                    <p><span><i class="fas fa-calendar-alt d-p"></i></span> <input id="datepick1" class="dp1" type="date"
                ...
                <div class="d-pic">
                    <p><span><i class="fas fa-calendar-alt d-p"></i></span> <input id="datepick2" class="dp2" type="date"
                                                                                   placeholder="check-out-date"></p>
                </div>

                <select name="adult" id="adult" class="form-control adult2">
                    <?php
                ...
                <div id="ch">
                    <select name="child" id="child" class="form-control child2">
                    ...
                    <select name="room" id="room" class="form-control room2">
        ...
        <div id="right-side" class="col-xs-12 col-sm-12 col-md-12 col-xl-9">
            ...
            <div class="row" id="fu">
                <div class="col-lg-2 col-md-2 col-xs-12 pics top" style="background-color: #0AB21B">
                    OUR TOP PICS
                </div>
                <div style="font-size: 12px;" class="col-lg-2 col-md-2  col-xs-12 pics pri">
                    GOOD-SUPERB
                </div>
                <div class="col-lg-2 col-xs-12  col-md-2  pics sta">
                    APARTMENT
                    <!--                    <i class="fas fa-sort-down" style="color: #d35400; font-size: 15px;"></i>-->
                </div>
                <div class="col-lg-3  col-md-3  col-xs-12 pics starprice">
                    BEACH FRONT
                </div>
                <div class="col-lg-3  col-md-3  col-xs-12 pics topreview">
                    COLOMBO DISTRICT
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('.top').click(function () {
        allWhite();
        $('.top').css("background-color","#0AB21B");
    });
    $('.pri').click(function () {
        allWhite();
        $('.pri').css("background-color","#0AB21B");
    });
    $('.sta').click(function () {
        allWhite();
        $('.sta').css("background-color","#0AB21B");
    });
    $('.starprice').click(function () {
        allWhite();
        $('.starprice').css("background-color","#0AB21B");
    });
    $('.topreview').click(function () {
        allWhite();
        $('.topreview').css("background-color","#0AB21B");
    });
    ...
    function allWhite() {
        ...
        $('.pri').css("background-color","white");
        $('.sta').css("background-color","white");
        $('.starprice').css("background-color","white");
        $('.starprice').css("background-color","white");
    }
    ...
    function loaddefault() {
        ...
        document.title='VISIT2SRILANKA| '+where;
        ...
        loadHotelNameWiceto(where, froms, to, rooms, child, adult);
